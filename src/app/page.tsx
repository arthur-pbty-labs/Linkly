            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <div className="text-center p-6 rounded-lg bg-background border border-border hover:shadow-lg transition-shadow">
                  ...
                  <h3 className="text-xl font-semibold text-card-foreground mb-2">Liens personnalisés</h3>
                  <p className="text-muted-foreground">Créez des liens avec vos propres codes personnalisés pour une meilleure mémorisation.</p>
                </div>
                ...
                <div className="text-center p-6 rounded-lg bg-background border border-border hover:shadow-lg transition-shadow">
                  ...
                  <h3 className="text-xl font-semibold text-card-foreground mb-2">Analytics détaillés</h3>
                  <p className="text-muted-foreground">Suivez les performances de vos liens avec des graphiques et statistiques avancés.</p>
                </div>
                ...
                <div className="text-center p-6 rounded-lg bg-background border border-border hover:shadow-lg transition-shadow">
                  ...
                  <h3 className="text-xl font-semibold text-card-foreground mb-2">QR Codes automatiques</h3>
                  <p className="text-muted-foreground">Chaque lien court génère automatiquement un QR code pour un partage facile.</p>
                </div>
              </div>
            </div>
          </section>
